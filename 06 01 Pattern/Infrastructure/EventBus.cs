namespace _06_01_Pattern.Infrastructure
{
    ...
    public class EventBus
    {
        ...
        public void Subscribe<TEvent>(Expression<Action<TEvent>> eventHandlerFuncExpression)
       where TEvent : class, IEvent
        {
            var func = eventHandlerFuncExpression.Compile();
            Subscribe<TEvent>(new ActionDelegatedEventHandler<TEvent>(func));
        }
